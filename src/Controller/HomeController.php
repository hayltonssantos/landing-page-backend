...
final class HomeController
{
    public function home(
        ...
        $data['informacoes'] = array(
            ...
            'description' => 'Projeto feito através do curso de PHP',
            'author' => 'Haylton Santos',
            'url' => URL_BASE.'',
            'site_name' => 'All In',
    ...
    public function contato_recebido(
        ...
        $data['informacoes'] = array(
            ...
            'description' => 'Sua mensagem foi recebida com sucesso, em breve nosso tima entrará em contato com você. Obrigado!',
            'author' => 'Haylton Santos',
